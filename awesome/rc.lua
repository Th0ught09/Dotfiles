...
awful.screen.connect_for_each_screen(function(s)
  ...
  local layouts = { l.tile, l.floating, l.fair, l.max,
    l.floating, l.tile.left, l.floating }
...
local globalkeys = gears.table.join(
  ...
  -- Standard program
  awful.key({ modkey, }, "Delete", function() awful.spawn(terminal) end,
    { description = "open a terminal", group = "launcher" }),
  awful.key({ modkey, }, "d", function() awful.spawn("rofi -show drun -display-drun") end,
  ...
  awful.key({ modkey, "Shift" }, "o", function() awful.spawn("xscreensaver-command -lock") end,
